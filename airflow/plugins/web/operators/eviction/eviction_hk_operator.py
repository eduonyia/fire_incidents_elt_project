...
# This custom operator is designed to handle the process of fetching data from the API endpoint and storing it in GCS. It is integrated into an Airflow DAG to automate the data pipelin